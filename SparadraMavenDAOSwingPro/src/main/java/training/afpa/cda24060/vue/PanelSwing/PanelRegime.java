...
public class PanelRegime extends JPanel {
    ...
    public PanelRegime() throws SQLException {
        initComponents();
    }
    ...
    private void supprimerRegime() throws SQLException {
        if (regimeIdSelectionne == -1) {
    ...
    private void chargerRegimes() throws SQLException {
    ...
    private void chargerRegimeDansFormulaire() throws SQLException {
