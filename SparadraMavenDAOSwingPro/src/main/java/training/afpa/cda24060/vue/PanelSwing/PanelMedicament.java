...
public class PanelMedicament extends JPanel {
    ...
    private JTextField txtDateMiseCirculation, txtQuantiteMedicament,txtFormeMedicament;
    ...
    public PanelMedicament() throws SQLException {
        initComponents();
        chargerMedicaments();
    }
    ...
    private JPanel creerPanelSaisie() {
        ...
        ajouterChamp(panel,"Forme :", txtFormeMedicament = new JTextField(15),0,2,gbc);
        ajouterChamp(panel,"Prix (€) :", txtPrixMedicament = new JTextField(15), 0, 3, gbc);
    ...
    private JPanel creerPanelRecherche() {
        ...
        btnRechercheCategorie.addActionListener(e -> {
            try {
    ...
    private void creerTable() {
        String[] colonnes = {"ID","Nom", "Catégorie", "Prix", "Date Circulation", "Quantité", "Sans Ordonnance","Forme"};
    ...
    private void ajouterMedicament() {
        try {
            ...
            String forme = txtFormeMedicament.getText().trim();
    ...
    private void modifierMedicament() {
        ...
        try{
            ...
            med.setFormeMedicament(txtFormeMedicament.getText());
    ...
    public void chargerMedicaments() throws SQLException {
        ...
        for(Medicament med: medicaments){
            modelMedicament.addRow(new Object[]{
                    ...
                    med.SansOrdonnanceMedicament()?"Oui":"Non",
                    med.getFormeMedicament()
            });
        }
    }

    private void chargerMedicamentDansFormulaire() throws SQLException {
        int row = tableMedicament.getSelectedRow();
        if(row!=-1){
            int id = (int) modelMedicament.getValueAt(row,0);
            Medicament med = medicamentDAO.findById(id);
            if(med!=null){
                ...
                txtFormeMedicament.setText(med.getFormeMedicament());
                ...
                cbSansOrdonnanceMedicament.setSelectedItem(med.SansOrdonnanceMedicament()?"Oui":"Non");
            }
        }
    }
    ...
    private void rechercherParCategorie() throws SQLException {
