...
public class PanelOrdonnance extends JPanel {
    ...
    private void initComponents() {
        ...
        // Panel haut (boutons)
        JPanel panelCreationOrdonnance = getJPanel();
    ...
    private @NotNull JPanel getJPanel() {
        ...
        return panelCreationOrdonnance;
    }
    ...
    private void creerOrdonnance(JDialog dialog, JTable tableClients, JTable tableMedecins,
        ...
        try {
            ...
            List<Client> clientsTrouves = clientDAO.findBy("nssClient", nssSelectionne, true);
            if (!clientsTrouves.isEmpty()) {
                clientSelectionne[0] = clientsTrouves.getFirst();
            }
